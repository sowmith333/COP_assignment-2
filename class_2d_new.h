...
//vector<string> explode2(string& s,char& c);
    ...
    class_2d(QString a, QString b, QString c, QString d, QString e, QString f):
...
vector<class_line> get_xz_lines();
    ...
    void loadxyPlane(QString file1, QString file2) ;			// Loader of plane xy

    void loadyzPlane(QString file1, QString file2) ;			// Loader of plane yz

    void loadzxPlane(QString file1, QString file2) ;
